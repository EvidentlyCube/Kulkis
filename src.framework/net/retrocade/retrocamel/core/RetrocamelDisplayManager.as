package net.retrocade.retrocamel.core {
	...
	public class RetrocamelDisplayManager {
		...
		private static var _shakeX:Number = 0;
		private static var _shakeY:Number = 0;

		public static function set shakeX(value:Number):void {
			_shakeX = value;
			onStageResize(null);
		}

		public static function set shakeY(value:Number):void {
			_shakeY = value;
			onStageResize(null);
		}
		...
		public static function setOffset(x:Number, y:Number):void {
			...
			_flashApplication.x = _offsetX + _shakeX;
			_flashApplication.y = _offsetY + _shakeY;
		}
		...
		public static function setBackgroundColor(color:uint):void {
			...
			_flashApplication.graphics.drawRect(0, 0, RetrocamelCore.settings.gameWidth, RetrocamelCore.settings.gameHeight);
