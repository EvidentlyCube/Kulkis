...
public class TStateLang extends RetrocamelStateBase {
    ...
    private var _bgLayer:RetrocamelLayerFlashBlit;
    ...
    public function TStateLang(parent:Sprite, bgLayer:RetrocamelLayerFlashBlit, startupFunction:Function) {
    ...
    override public function create():void {
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFFAA0000, 0xFF220000);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFF00AA00, 0xFF002200);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFF0000AA, 0xFF000022);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFFAAAA00, 0xFF222200);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFFAA00AA, 0xFF220022);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFF00AAAA, 0xFF002222);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFFAA0000, 0xFF220000);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFF00AA00, 0xFF002200);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFF0000AA, 0xFF000022);
        new PixelBugEffect(_bgLayer, S().gameWidth, S().gameHeight, 1 + Math.random() * 5, 0xFFAAAA00, 0xFF222200);
