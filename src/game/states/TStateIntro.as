...
public class TStateIntro extends RetrocamelStateBase {
    ...
    private var _isHardMode:Boolean;
    ...
    public function setMode(isHardMode:Boolean):void{
        ...
        _tStory1.text = _("intro1"+suffix);
        _tStory2.text = _("intro2"+suffix);
        _tStory3.text = _("intro3"+suffix);
        _tStory4.text = _("intro4"+suffix);
        _tStory5.text = _("intro5"+suffix);
        _tStory6.text = _("intro6"+suffix);
        _tStory7.text = _("intro7"+suffix);
        _tStory8.text = _("intro8"+suffix);
        _tStory9.text = _("intro9"+suffix);
        _tStoryA.text = _("introA"+suffix);
        _tStoryB.text = _("introB"+suffix);
        _tStoryC.text = _("introC"+suffix);
