...
public class Pre {
    ...
    public static function init():void {
        ...
        RetrocamelDisplayManager.scaleToFit = RetrocamelSimpleSave.read('scaleToFit', true);
        RetrocamelDisplayManager.scaleToInteger = RetrocamelSimpleSave.read('scaleToInteger', true);
        ...
        RetrocamelInputManager.keyDownSignal.add(function (keyCode:int):void {
            switch (keyCode) {
                case(KeyConst.F4):
                    ...
                    RetrocamelSimpleSave.write('scaleToFit', RetrocamelDisplayManager.scaleToFit);
                    RetrocamelSimpleSave.write('scaleToInteger', RetrocamelDisplayManager.scaleToInteger);
                    break;
                case(KeyConst.F11):
    ...
    private static function loadOptions():void {
        RetrocamelSimpleSave.setStorage('ecKulkis');

        Music.musicVolume = RetrocamelSimpleSave.read('optVolumeMusic', 1.0);
