...
public class Sfx {
    ...
    public static function startGenerating(callback:Function):void {
        sfxDeath.cacheSound(callback, 10);
        sfxChangeColor.cacheSound(callback, 10);
        sfxLevelCompleted.cacheSound(callback, 10);
        sfxBlockBoom.cacheMutations(5, callback, 20, 0.02);
        sfxPlayerBounce.cacheMutations(5, callback, 20, 0.05);
    }
}
}